...
do
  # echo $part;
  lastOne=${part: -1};
  cp $part ../../../index/index/inverted_index/inverted_index_$lastOne.txt;
done
# cp output5/part-00000 ../../index/index/inverted_index/inverted_index_0.txt
# cp output5/part-00001 ../../index/index/inverted_index/inverted_index_1.txt
# cp output5/part-00002 ../../index/index/inverted_index/inverted_index_2.txt